...
- Depends on true per-leg places from [`carpool-meet-at`](carpool-meet-at.md)
  (rank 1) — more valuable once legs aren't stuck at requester house.
- After [`carpool-route-optimize`](carpool-route-optimize.md) (rank 2) so
