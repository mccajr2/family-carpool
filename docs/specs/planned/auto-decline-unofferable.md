...
**Depends on:** [`coverage-priority-engine`](../archive/coverage-priority-engine.md), [`ride-revert-undo`](../specs/active/ride-revert-undo.md)  
...
- Previously auto-declined requests become reconsiderable when a confirmed driver is assigned (falls out of [`ride-revert-undo`](../active/ride-revert-undo.md) gating).
