...
- Previously auto-declined requests become reconsiderable when a confirmed driver is assigned (falls out of [`ride-revert-undo`](../archive/ride-revert-undo.md) gating).
