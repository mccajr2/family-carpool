...
carpool is dogfoodable. Promote with `/roadmap`, then `/spec agenda-full-page-redesign-mobile`.
...
- Depends on shipped web [`agenda-full-page-redesign`](../archive/agenda-full-page-redesign.md)
  plus [`agenda-list-chips`](agenda-list-chips.md) — port chip/avatar collapsed
  rows, not the pre-chip list.
