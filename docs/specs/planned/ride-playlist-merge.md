...
Cancelled: 2026-09-06 — superseded by [`ride-playlist-tab`](../archive/ride-playlist-tab.md)

Thin stub retained for history. Do not `/spec` or implement this id.

## Problem

(Original) Merge kids’ ride playlists preferring shared songs, balance coverage,
shuffle, pin lucky songs.

## Notes

- Approved mockup uses **round-robin** merge (`mergeTracks`) and lives under
  [`ride-playlist-tab`](../archive/ride-playlist-tab.md) —
