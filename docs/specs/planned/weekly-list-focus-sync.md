...
**Depends on:** [`coverage-priority-engine`](../active/coverage-priority-engine.md), [`household-driver-assignment`](../planned/household-driver-assignment.md), [`unified-ride-status-chip`](../planned/unified-ride-status-chip.md), [`hero-attention-carousel`](../planned/hero-attention-carousel.md)
