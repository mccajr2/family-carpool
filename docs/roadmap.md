...
Status: active  
Updated: 2026-09-16 (`/spec player-conflict-hero`)
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | player-conflict-hero            | active  | 2026-09-16 · enhancement   | Same-kid overlap → Hero shows both events; force keep one / not-going on the other; then ride assign (builds on `KID_TIME_OVERLAP`; depends on `hero-not-going`) |
| 2    | family-conflict-report          | planned | 2026-09-16 · enhancement   | Different kids’ overlapping events → clear lower-urgency Agenda report (who + events); no forced Hero; not adult-coverage amber |
...
| Id                   | Started    | Branch / spec                                              |
| -------------------- | ---------- | ---------------------------------------------------------- |
| player-conflict-hero | 2026-09-16 | `player-conflict-hero` · [spec](specs/active/player-conflict-hero.md) |
