...
Status: active  
Updated: 2026-08-26 (`/spec agenda-carpool-action-parity`)
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | agenda-carpool-action-parity    | active  | 2026-08-26 · enhancement   | Calendar self-sufficient ride lifecycle: Cancel on Focus; Withdraw when we accepted; Pass CTA on Carpool tab (not un-pass)    |
...
| 3    | agenda-chip-section-headers     | planned | 2026-08-26 · enhancement   | Agenda status chips = Feeds (uppercase, no bullet); section labels NEEDS YOUR ATTENTION…LATER; update design docs             |
...
| Id | Branch | Spec |
| --- | --- | --- |
| agenda-carpool-action-parity | `agenda-carpool-action-parity` | [active](specs/active/agenda-carpool-action-parity.md) |
