...
Status: active  
Updated: 2026-08-17 (`/spec agenda-focus-card-polish`)
...
| ---- | ---------------------------------- | ------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | agenda-focus-card-polish           | active  | 2026-08-17 · enhancement                                         | Web Focus card: larger isolated ring, covering under ring, overlap chip; same handlers (after next-action ranking)                                              |
...
| 6    | agenda-full-page-redesign-mobile   | planned | 2026-08-15 · enhancement                                         | iOS + Android day-grouped rows including list chips (after web `agenda-list-chips`)                                                                             |
| 7    | feeds-page-redesign-mobile         | planned | 2026-08-15 · enhancement                                         | iOS + Android port of Feeds card restyle (after web `feeds-page-redesign`)                                                                                      |
| 8    | agenda-week-glance-mobile          | planned | 2026-08-17 · enhancement                                         | iOS + Android five-day status strip (after web `agenda-week-glance`)                                                                                            |
| 9    | carpool-request-accept             | planned | 2026-08-07 · initial                                             | Multi-kid default ride request + deselect override; accept; seat updates                                                                                        |
| 10   | manual-event-team-link             | planned | 2026-08-13 · re-rank split                                       | Manual events: attach to a team (feed UUID, carpool-eligible) or standalone (family tracking only)                                                              |
...
| Id | Branch | Spec |
| --- | --- | --- |
| agenda-focus-card-polish | `agenda-focus-card-polish` | [active](specs/active/agenda-focus-card-polish.md) |
...
| 2026-08-17 | `/spec agenda-focus-card-polish`: mock-aligned Focus header — isolated ring, covering under ring, status chips; no selection/handler changes. |
