...
Status: active  
Updated: 2026-09-13 (`/pr carpool-kid-split-plans` — archive)
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | carpool-meet-at                 | planned | 2026-08-14 · enhancement   | Ask-team meet-at sub-flow + true per-leg pickup/drop-off places (locations deferred from leg-split)                         |
