...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | player-conflict-hero            | planned | 2026-09-16 · enhancement   | Same-kid overlap → Hero shows both events; force keep one / not-going on the other; then ride assign (builds on `KID_TIME_OVERLAP`; depends on `hero-not-going`) |
