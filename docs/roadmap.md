...
Status: active  
Updated: 2026-08-13 (`/spec team-carpool-space-invite`)
...
| ---- | ------------------------------ | ------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | team-carpool-space-invite      | active  | 2026-08-07 · initial                                             | Enable team carpool space; parent invite code; code also adds feed; request/admit; feed stays calendar-only                                                     |
| 2    | garage-vehicles                | planned | 2026-08-07 · initial                                             | Adult garage; NHTSA seat hints + manual override; 0 vehicles / don’t drive still full Caregiver                                                                 |
...
| Id | Branch | Spec |
| -- | ------ | ---- |
| team-carpool-space-invite | `team-carpool-space-invite` | [active](specs/active/team-carpool-space-invite.md) |
