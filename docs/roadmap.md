...
Status: active  
Updated: 2026-08-10 (`ui-system-destination-adoption` → Upcoming)
...
| 2 | ui-system-destination-adoption | planned | 2026-08-10 · note carried from cross-platform-ui-system approval | Adopt shared tokens on remaining destinations; re-run screenshots + WCAG AA per surface (Calendar/Family first; Carpool only after carpool features exist) |
...
| 2026-08-10 | Promoted `ui-system-destination-adoption` → Upcoming rank 2 (Calendar/Family first; Carpool UI after carpool features). |
