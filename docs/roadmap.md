...
| 5    | agenda-week-glance-mobile          | planned | 2026-08-17 · enhancement                                         | iOS + Android five-day status strip (after web `agenda-week-glance`)                                                                                            |
...
| 14   | family-calendar-grid               | planned | 2026-08-10 · re-rank split                                       | iOS-style **month/week calendar grid** on top of the unified schedule (after Agenda UX is solid on web + mobile)                                                |
| 15   | ui-system-destination-adoption     | planned | 2026-08-10 · note carried from cross-platform-ui-system approval | Remainder token adoption (Carpool / Family / Places / Garage / grid) — Agenda/Feeds redesigns already adopt; re-run screenshots + WCAG AA per leftover surface |
| 16   | typography-font-family             | planned | 2026-08-14 · enhancement                                         | iOS + Android font pairing (asset bundling); web shipped separately as `typography-web`                                                                         |
