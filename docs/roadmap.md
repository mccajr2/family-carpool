...
Status: active  
Updated: 2026-08-17 (`/roadmap` Claude Calendar + Feeds intake)
...
| Web shell rail           | Signed-in web chrome is an **always-dark docked left rail** (independent of page theme): Calendar / Carpool / Family with icons; Settings Places / Garage / Feeds; **ACCOUNT** footer (avatar, email, role, sign out). iOS/Android keep bottom tabs. Display wordmark may say “Fam.” until `[app-identity-rename](specs/planned/app-identity-rename.md)` — do not rename packages in the rail slice. `[web-shell-nav-rail](specs/planned/web-shell-nav-rail.md)` |
...
| ---- | ---------------------------------- | ------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | web-shell-nav-rail                 | planned | 2026-08-17 · enhancement                                         | Web always-dark docked rail: icons, ACCOUNT footer; same destinations/handlers                                                                                  |
