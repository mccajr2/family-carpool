...
Status: active  
Updated: 2026-08-26 (`/pr agenda-carpool-action-parity`)
...
| 2    | agenda-chip-section-headers     | planned | 2026-08-26 · enhancement   | Agenda status chips = Feeds (uppercase, no bullet); section labels NEEDS YOUR ATTENTION…LATER; update design docs             |
