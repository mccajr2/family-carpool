...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | hero-attention-carousel         | active  | 2026-08-28 · initial       | Swipeable "Needs your attention" carousel over `getQueue`; every slide actionable; empty → all caught up                      |
| 2    | weekly-list-focus-sync          | planned | 2026-08-28 · initial       | Collapsed-by-default agenda rows; highlight syncs to `getQueue[0]`; chronological list order                                    |
| 3    | ride-revert-undo                | planned | 2026-08-28 · initial       | One-click, no-dialog undos for every resolved ride state; **drive** vocabulary for ride-side copy                             |
| 4    | auto-decline-unofferable        | planned | 2026-08-28 · initial       | Wire auto-decline when own ride is `"requested"` — can't offer a ride you don't have                                        |
| 5    | attendance-manual-toggle        | planned | 2026-08-28 · initial       | Manual not-going toggle only; default going; never a hero item; **going** vocabulary                                         |
| 6    | carpool-pickup-detour           | planned | 2026-08-28 · initial       | Pickup town + color-coded detour minutes before Accept/Decline on carpool asks                                                |
| 7    | coverage-copy-a11y-polish       | planned | 2026-08-28 · initial       | Copy constants, layout separation, a11y/responsive polish pass across ranks 2–9                                               |
| 8    | agenda-ride-rider-chips         | planned | 2026-08-26 · enhancement   | Initials circles + first-name labels for who's riding (reuse covering-avatar pattern); names only — no photos                 |
| 9    | auth-email-delivery             | planned | 2026-08-07 · enhancement   | Production SMTP/API mail for OTP — pre-beta gate (dev keeps log delivery); needed before real-device Expo auth                 |
| 10   | rn-expo-scaffold                | planned | 2026-08-25 · enhancement   | Expo app: OTP auth + shell + push-token registration hook against existing OpenAPI — infra for carpool push beta              |
| 11   | push-notifications              | planned | 2026-08-07 · initial       | Expo push for carpool ride **request / accept / deny (pass)** — pre-beta differentiator; not blocked on in-app inbox          |
| 12   | manual-event-team-link          | planned | 2026-08-13 · re-rank split | Manual events: attach to a team (feed UUID, carpool-eligible) or standalone (family tracking only) — web first                |
| 13   | carpool-recurring-rotation      | planned | 2026-08-16 · enhancement   | Standing teammate rotation for a recurring team event (e.g. every Tuesday); RSVP No drops that kid for that week only         |
| 14   | event-arrival-lead-time         | planned | 2026-08-11 · enhancement   | Editable arrival lead times: game ~30m / practice ~15m / other ~0 (defaults); refine leave-by target                          |
| 15   | coverage-leave-from             | planned | 2026-08-12 · enhancement   | Leave-from (and leave-by) per coverage when adults take separate cars/kids                                                    |
| 16   | conflict-travel-margin          | planned | 2026-08-12 · enhancement   | Soft "cutting it close" warn from leave-by/travel gaps (not hard overlap; after leave-from / lead-time)                       |
| 17   | calendar-conditional-get        | planned | 2026-08-12 · re-rank split | Server `ETag` + client `If-None-Match` / `304` on calendar background revalidate (after cheap list + client cache)            |
| 18   | event-venue-display-label       | planned | 2026-08-17 · enhancement   | Short venue label (rink, park, field) from geocoded event destination; Focus + Agenda fallback to full `location`             |
| 19   | web-auth-session-hardening      | planned | 2026-08-07 · enhancement   | HTTP-only cookie (or equivalent) for web — pre-beta gate; Expo stays Bearer                                                   |
...
| 21   | app-identity-rename             | planned | 2026-08-07 · initial       | Rename packages/clients from quickapp template identity before public beta                                                    |
...
| Id                      | Branch                    | Spec                                              |
| ----------------------- | ------------------------- | ------------------------------------------------- |
| hero-attention-carousel | `hero-attention-carousel` | [active](specs/active/hero-attention-carousel.md) |
