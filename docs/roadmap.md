...
Status: active  
Updated: 2026-09-01 (`/pr coverage-copy-a11y-polish`)
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | agenda-ride-rider-chips         | planned | 2026-08-26 · enhancement   | Initials circles + first-name labels for who's riding (reuse covering-avatar pattern); names only — no photos                 |
| 2    | ride-commitment-conflict        | planned | 2026-09-01 · initial       | Surface contradictory ride commitments (need ride + accepted inbound, mutual swap); Phase 1 web chips/Focus; Phase 2 → audit   |
