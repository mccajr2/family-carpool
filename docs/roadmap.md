...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | ride-detail-route-only          | planned | 2026-09-08 · enhancement   | Hide Playlist tab chrome on confirmed-ride detail; Route-only surface (Spotify code stays dormant)                            |
