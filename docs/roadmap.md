...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | carpool-kid-split-plans         | active  | 2026-09-10 · re-rank split | Progressive per-kid plans for multi-kid teams (twins/triplets); default remains shared round-trip                           |
...
| Id | Branch | Spec |
| -- | ------ | ---- |
| carpool-kid-split-plans | `carpool-kid-split-plans` | [active](specs/active/carpool-kid-split-plans.md) |
