...
Status: active  
Updated: 2026-08-26 (`/pr agenda-chip-section-headers`)
...
| Rank | Id                              | Status  | Added                      | Summary                                                                                                                       |
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | agenda-carpool-state-clarity    | planned | 2026-08-26 · enhancement   | Focus + expanded AgendaRow ride lines show who/where/kids/seats (match Carpool tab density; keep Focus slim otherwise)        |
