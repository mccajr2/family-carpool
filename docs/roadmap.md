...
Status: active  
Updated: 2026-09-06 (`/spec ride-detail-shell`)
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | ride-detail-shell               | active  | 2026-09-06 · enhancement   | Home `canRoute` entry + per-event Detail Route/Playlist tabs (fixture data OK); mockup SoT `carpool_combined_flow.jsx`        |
...
| Id | Branch | Spec |
| -- | ------ | ---- |
| ride-detail-shell | `ride-detail-shell` | [specs/active/ride-detail-shell.md](specs/active/ride-detail-shell.md) |
