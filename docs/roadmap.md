...
Status: active  
Updated: 2026-09-10 (`/roadmap` garage retire recovery)
...
| Circle writes            | **Organizer-only:** kids, invite/roles, circle rename, **activity feeds** (+ Sync). **Any member:** **named places**, **manual events**. **Garage vehicle writes:** retiring via active `[garage-retire](specs/active/garage-retire.md)` then parking `[garage-capacity](specs/planned/garage-capacity.md)` — prior ship: `[garage-vehicles](specs/archive/garage-vehicles.md)`                                                                                                                                                                                      |
...
| Vehicle specs            | **Parked with capacity.** Prior ship: year/make/model (vPIC), no VIN, overridable total seats — `[garage-vehicles](specs/archive/garage-vehicles.md)`. **Retire from product** via active `[garage-retire](specs/active/garage-retire.md)`. Revive later: parking `[garage-capacity](specs/planned/garage-capacity.md)`; seat kinds `[garage-seat-kinds](specs/planned/garage-seat-kinds.md)`. Do **not** gate Accept on vehicles/seats until capacity returns.                                                                                                                                                                              |
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | garage-retire                   | active  | 2026-09-10 · enhancement   | **Recovery:** remove Garage from nav; decouple Accept from vehicles/seats/`vehicleId`; hard-delete garage API/UI/schema |
...
| Id | Branch | Spec |
| -- | ------ | ---- |
| garage-retire | `garage-retire` | [active](specs/active/garage-retire.md) |
