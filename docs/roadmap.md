...
Status: active  
Updated: 2026-08-26 (`/spec agenda-chip-section-headers`)
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | agenda-chip-section-headers     | active  | 2026-08-26 · enhancement   | Agenda status chips = Feeds (uppercase, no bullet); section labels NEEDS YOUR ATTENTION…LATER; update design docs             |
...
| 4    | assign-cancels-carpool-request  | planned | 2026-08-26 · enhancement   | Assign (family coverage) should cancel open carpool ask when those kids are covered — stop teammate false pickup expectation |
...
| Id | Branch | Spec |
| --- | --- | --- |
| agenda-chip-section-headers | `agenda-chip-section-headers` | [active](specs/active/agenda-chip-section-headers.md) |
