...
Status: active  
Updated: 2026-08-21 (amend carpool RSVP + add `calendar-item-event-key`)
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | agenda-focus-carpool-actions    | active  | 2026-08-17 · enhancement   | Agenda-primary carpool (web): Request without prior Yes; Accept→Yes; Focus Accept/Pass/Request; per-adult Pass |
| 2    | calendar-item-event-key         | planned | 2026-08-21 · enhancement   | Expose feed `uid`/`eventKey` on `CalendarItem` for solid Agenda↔ride join (replace flaky title/time match)                    |
