...
| 2026-08-31 | `/pr attendance-manual-toggle`: Agenda AttendanceToggle (going/not going) replaces three-way RSVP select; client maps to existing `YES`/`NO` API. Spec archived. Next up `auto-decline-unofferable`. |
