...
Status: active  
Updated: 2026-09-07 (`/spec ride-playlist-tab`)
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | ride-playlist-tab               | active  | 2026-09-06 · enhancement   | Confirmed-ride Playlist: Spotify OAuth, round-robin merge, Open in Spotify, remix, invite-to-connect                          |
| 2    | ride-detail-polish              | planned | 2026-09-06 · enhancement   | Route/Playlist loading, notify/invite errors, explicit OSRM-unreachable leave-by state                                        |
...
| 6    | push-notifications              | planned | 2026-08-07 · initial       | Expo push for carpool ride **request / accept / deny (pass)** — also backs route/playlist notify call sites when ready        |
...
| ride-playlist-merge           | 2026-09-06 | Superseded by [`ride-playlist-tab`](specs/active/ride-playlist-tab.md) (mockup round-robin merge) |
...
| Id                | Branch              | Spec                                           |
| ----------------- | ------------------- | ---------------------------------------------- |
| ride-playlist-tab | `ride-playlist-tab` | [active](specs/active/ride-playlist-tab.md)    |
