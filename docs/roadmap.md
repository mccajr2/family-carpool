...
Status: active  
Updated: 2026-08-18 (`/pr agenda-week-glance`)
...
| Agenda week strip        | **Five-day coverage/status** rail in Calendar Context (today + next four local days; event counts, not kids; no driver copy). Not the month/week grid (`family-calendar-grid`). Done: `[agenda-week-glance](specs/archive/agenda-week-glance.md)`. Mobile port: `[agenda-week-glance-mobile](specs/planned/agenda-week-glance-mobile.md)`. The mock’s numbered-stop **carpool card** + Open in Maps stays parked `[carpool-multi-stop](specs/planned/carpool-multi-stop.md)`. |
...
| ---- | ---------------------------------- | ------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | agenda-focus-card-mobile           | planned | 2026-08-14 · enhancement                                         | iOS + Android port of the polished Focus card (after web next-action + polish)                                                                                  |
| 2    | agenda-full-page-redesign-mobile   | planned | 2026-08-15 · enhancement                                         | iOS + Android day-grouped rows including list chips (after web `agenda-list-chips`)                                                                             |
| 3    | feeds-page-redesign-mobile         | planned | 2026-08-15 · enhancement                                         | iOS + Android port of Feeds card restyle (after web `feeds-page-redesign`)                                                                                      |
| 4    | agenda-week-glance-mobile          | planned | 2026-08-17 · enhancement                                         | iOS + Android five-day status strip (after web `agenda-week-glance`)                                                                                            |
