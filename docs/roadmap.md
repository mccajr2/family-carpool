...
Status: active  
Updated: 2026-09-16 (`/pr` day-block-agenda; merge main schedule-conflict ranks)
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | hero-not-going                  | active  | 2026-09-16 · re-rank split | Own-kid Hero slides: mark not going without Confirm/Assign or digging into Agenda (shared affordance; prereq for player-conflict) |
| 2    | player-conflict-hero            | planned | 2026-09-16 · enhancement   | Same-kid overlap → Hero shows both events; force keep one / not-going on the other; then ride assign (builds on `KID_TIME_OVERLAP`; depends on `hero-not-going`) |
| 3    | family-conflict-report          | planned | 2026-09-16 · enhancement   | Different kids’ overlapping events → clear lower-urgency Agenda report (who + events); no forced Hero; not adult-coverage amber |
...
| Id | Branch | Spec |
| -- | ------ | ---- |
| hero-not-going | `hero-not-going` | [active](specs/active/hero-not-going.md) |
