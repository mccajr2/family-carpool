...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | hero-attention-carousel         | planned | 2026-08-28 · initial       | Swipeable "Needs your attention" carousel over `getQueue`; every slide actionable; empty → all caught up                      |
