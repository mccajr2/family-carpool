...
Status: active  
Updated: 2026-09-07 (`/spec ride-route-tab`)
...
| Arrival lead time        | Route tab locks interim buffers until editable: game **45** / practice **20** / other **0** — [`ride-route-tab`](specs/active/ride-route-tab.md). Follow-up [`event-arrival-lead-time`](specs/planned/event-arrival-lead-time.md) makes them editable and reconciles Agenda single-origin leave-by (do not silently diverge)                                                                                                                                                                                                                                                                    |
...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | ride-route-tab                  | active  | 2026-09-06 · enhancement   | Confirmed-ride Route: OSRM legs, stops, leave-by hero, map/placeholder, Start navigation, notify ready-by                     |
| 2    | ride-playlist-tab               | planned | 2026-09-06 · enhancement   | Confirmed-ride Playlist: Spotify OAuth, round-robin merge, Open in Spotify, remix, invite-to-connect                          |
| 3    | ride-detail-polish              | planned | 2026-09-06 · enhancement   | Route/Playlist loading, notify/invite errors, explicit OSRM-unreachable leave-by state                                        |
...
| 7    | push-notifications              | planned | 2026-08-07 · initial       | Expo push for carpool ride **request / accept / deny (pass)** — also backs route/playlist notify call sites when ready        |
...
| 10   | event-arrival-lead-time         | planned | 2026-08-11 · enhancement   | Editable arrival lead times; reconcile Agenda + Route `bufferMinutes` (Route interim lock: 45/20/0 via `ride-route-tab`)     |
...
| Id                            | Cancelled  | Reason |
| ----------------------------- | ---------- | ------ |
| carpool-multi-stop            | 2026-09-06 | Superseded by approved Route/Playlist flow — [`ride-route-tab`](specs/active/ride-route-tab.md) |
| driver-leave-by-pickups       | 2026-09-06 | Absorbed into [`ride-route-tab`](specs/active/ride-route-tab.md) (multi-stop leave-by) |
| maps-deep-links               | 2026-09-06 | Absorbed into [`ride-route-tab`](specs/active/ride-route-tab.md) (Google Maps universal deep link) |
...
| Id | Branch | Spec |
| -- | ------ | ---- |
| ride-route-tab | `ride-route-tab` | [active](specs/active/ride-route-tab.md) |
