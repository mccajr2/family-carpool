...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | ride-revert-undo                | active  | 2026-08-28 · initial       | One-click, no-dialog undos for every resolved ride state; **drive** vocabulary for ride-side copy                             |
| 2    | auto-decline-unofferable        | planned | 2026-08-28 · initial       | Wire auto-decline when own ride is `"requested"` — can't offer a ride you don't have                                        |
| 3    | attendance-manual-toggle        | planned | 2026-08-28 · initial       | Manual not-going toggle only; default going; never a hero item; **going** vocabulary                                         |
| 4    | carpool-pickup-detour           | planned | 2026-08-28 · initial       | Pickup town + color-coded detour minutes before Accept/Decline on carpool asks                                                |
| 5    | coverage-copy-a11y-polish       | planned | 2026-08-28 · initial       | Copy constants, layout separation, a11y/responsive polish pass across ranks 2–9                                               |
| 6    | agenda-ride-rider-chips         | planned | 2026-08-26 · enhancement   | Initials circles + first-name labels for who's riding (reuse covering-avatar pattern); names only — no photos                 |
...
| Id                            | Cancelled  | Reason |
| ----------------------------- | ---------- | ------ |
| assign-cancels-carpool-request | 2026-08-28 | Superseded by hero & coverage flow redesign — [`auto-decline-unofferable`](specs/planned/auto-decline-unofferable.md) + [`ride-revert-undo`](specs/active/ride-revert-undo.md) |
...
| Id               | Branch             | Spec                                              |
| ---------------- | ------------------ | ------------------------------------------------- |
| ride-revert-undo | `ride-revert-undo` | [active](specs/active/ride-revert-undo.md)        |
