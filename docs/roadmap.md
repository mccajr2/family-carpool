...
Status: active  
Updated: 2026-08-26 (`/spec agenda-carpool-state-clarity`)
...
| Rank | Id                              | Status  | Added                      | Summary                                                                                                                       |
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | agenda-carpool-state-clarity    | active  | 2026-08-26 · enhancement   | Focus + expanded AgendaRow ride lines show who/where/kids/seats (match Carpool tab density; keep Focus slim otherwise)        |
| 2    | assign-cancels-carpool-request  | planned | 2026-08-26 · enhancement   | Assign (family coverage) should cancel open carpool ask when those kids are covered — stop teammate false pickup expectation |
...
| Id | Branch | Spec |
| -- | ------ | ---- |
| agenda-carpool-state-clarity | `agenda-carpool-state-clarity` | [active](specs/active/agenda-carpool-state-clarity.md) |
