...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | weekly-list-focus-sync          | planned | 2026-08-28 · initial       | Collapsed-by-default agenda rows; highlight syncs to `getQueue[0]`; chronological list order                                    |
