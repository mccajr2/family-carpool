...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | coverage-priority-same-event    | active  | 2026-09-08 · enhancement   | After own coverage for event E, pending carpool asks for **E** before own gaps on later events (amends ADR-0001)              |
...
| Id | Branch | Spec |
| -- | ------ | ---- |
| coverage-priority-same-event | `coverage-priority-same-event` | [active](specs/active/coverage-priority-same-event.md) |
