...
| ---- | ------------------------------- | ------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1    | unified-ride-status-chip        | active  | 2026-08-28 · initial       | One glanceable status chip per game incl. **You're driving · +N**; separate CarpoolAskChip for inbound asks                   |
...
| Id                       | Branch                       | Spec                                                         |
| ------------------------ | ---------------------------- | ------------------------------------------------------------ |
| unified-ride-status-chip | `unified-ride-status-chip` | [active](specs/active/unified-ride-status-chip.md) |
