...
Status: active  
Updated: 2026-08-14 (`/spec garage-vehicles` amend: drivers + kept-at)
...
| Circle writes            | **Organizer-only:** kids, invite/roles, circle rename, **activity feeds** (+ Sync). **Any member:** **named places**, **manual events**. **Garage:** any member, **owner-only** vehicle writes (including who may drive); circle-visible read — `[garage-vehicles](specs/active/garage-vehicles.md)`                                                                                                                                                                                                                                                                        |
| Driving                  | Orthogonal to role: **0+ vehicles** or “don’t drive”; non-drivers stay full Caregivers and can **request** rides. A vehicle has an **owner** plus explicit **drivers** (same house does not imply sharing) — `[garage-vehicles](specs/active/garage-vehicles.md)`                                                                                                                                                                                                                                                                                                              |
...
| Vehicle specs            | User picks **year / make / model** (vPIC lists); **no VIN**. vPIC suggests **total seats including driver**; always overridable. Kid vs adult vs booster kinds → parking `[garage-seat-kinds](specs/planned/garage-seat-kinds.md)`. Active: `[garage-vehicles](specs/active/garage-vehicles.md)`                                                                                                                                                                                                                                                                              |
...
| ---- | ------------------------------ | ------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | garage-vehicles                | active  | 2026-08-07 · initial                                             | Adult garage; year/make/model + overridable seats (no VIN); owner + who-can-drive; optional kept-at place                                                       |
...
| Id              | Branch            | Spec                                              |
| --------------- | ----------------- | ------------------------------------------------- |
| garage-vehicles | `garage-vehicles` | [active](specs/active/garage-vehicles.md)         |
