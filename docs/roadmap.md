...
Status: active  
Updated: 2026-08-17 (`/spec web-shell-nav-rail`)
...
| ---- | ---------------------------------- | ------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | web-shell-nav-rail                 | active  | 2026-08-17 · enhancement                                         | Web always-dark docked rail: icons, ACCOUNT footer; same destinations/handlers                                                                                  |
...
| Id | Branch | Spec |
| -- | ------ | ---- |
| web-shell-nav-rail | `web-shell-nav-rail` | [active](specs/active/web-shell-nav-rail.md) |
